...
\begin{center}
  \Large{ \begin{tabu}{ c l r } \multirow{4}{1in}{\includegraphics[width=0.78in]{author.jpg}} & \textbf{周志宇} \\ & \email{zhouzhiyuwhu@gmail.com} \\ & \phone{(+86) 187-620-29645} \\ & \github[github.com/zzywhu]{https://github.com/zzywhu}\end{tabu} }
\end{center}
...
\role{SLAM算法工程师}{实习}
参与轮式机器人底盘多传感器 SLAM 系统维护，并负责基于反光条的高精度回冲定位算法开发。
